...
gboolean mc_keymap_bind_keycode (const char *group, const char *name, char *pressed_keynames,
                                 GError ** error);
gboolean mc_keymap_bind_event (const char *group, const char *name, const char *event_group,
                               const char *event_name, GError ** error);
gboolean mc_keymap_mass_bind_event (mc_keymap_event_init_t *, GError ** error);
