...
gboolean
mc_core_cmd_configuration_show_dialog (event_info_t * event_info, gpointer data, GError ** error)
{
...
gboolean
mc_core_cmd_configuration_confirmations_show_dialog (event_info_t * event_info, gpointer data,
                                                     GError ** error)
{
    (void) error;
    (void) event_info;
...
gboolean
mc_core_cmd_configuration_display_bits_show_dialog (event_info_t * event_info, gpointer data,
                                                    GError ** error)
{
    (void) error;
    (void) event_info;
...
gboolean
mc_core_cmd_configuration_vfs_show_dialog (event_info_t * event_info, gpointer data,
                                           GError ** error)
{
...
gboolean
mc_core_cmd_show_background_jobs (event_info_t * event_info, gpointer data, GError ** error)
{
    struct
    {
        const char *name;
