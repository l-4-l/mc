...
gboolean
mc_core_cmd_panelize (event_info_t * event_info, gpointer data, GError ** error)
{
    (void) error;
    (void) event_info;
    (void) data;
...
gboolean
mc_core_cmd_external_panelize (event_info_t * event_info, gpointer data, GError ** error)
{
    char *target = NULL;
